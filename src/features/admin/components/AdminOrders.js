...
function AdminOrders() {
  ...
  const handleEdit = (order) => {
    console.log('handleEdit ', editableOrderId===order.id);  
            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th
                    className="py-6 px-0 text-left cursor-pointer"
                    onClick={(e) =>
                      handleSort({
                        sort: 'totalAmount',
                        order: sort?._order === 'asc' ? 'desc' : 'asc',
              ...
              <tbody className="text-gray-600 text-sm font-light">
                {orders.map((order) => (
                  ...
                  >
                    ...
                    <td className="mr-1 py-6 px-0 text-left">
                      {order.items.map((item, index) => (
                        <div key={index} className="flex items-center">
                         
                          <span>
                            {item.product.title} - #{item.quantity} - <i class="fa fa-rupee pr-1"></i>
                    ...
                    <td className="py-3 px-0 text-center">
                      ...
                      <i class="fa fa-rupee pr-1"></i>{order.totalAmount}
                      </div>
                    </td>
                    <td className="py-3 px-0 text-center">
                      <div className="">
